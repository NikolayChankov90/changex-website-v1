export const faqContent = [
    {
        title: 'What is a DeFi non-custodial walletPage?',
        content: 'A non-custodial walletPage lets you safely store your crypto assets under your full control. ' +
            'No central authority has access to them. Since Changex’s walletPage is non-custodial, ' +
            ...
            'To use the walletPage, you do not need to register, go through KYC procedures and you can remain anonymous. ' +
            'The DeFi part means that your non-custodial walletPage also allows you to connect to and use different' +
    ...
    },
    {
      ...
      content: 'Delegated staking (aka Offline Staking) is a method for staking Hydra without having the need for internet connection. ' +
          ...
          'Also the UTXO must mature 2000 blocks to be used.When a user has earned more than 5 HYDRA from staking the amount is sent to their walletPage. ' +
    ...
    },
    {
        ...
        content: 'The Changex Crypto Debit Card is connected to your walletPage and your bank account at the same time. Using' +
